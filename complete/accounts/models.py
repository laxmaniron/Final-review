...
class Company(models.Model):  # [Table of companies ]
    company_name = models.CharField(
        max_length=100, default='', primary_key=True)
...
class UserProfile(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.PROTECT)  # or models.CASCADE
    ...
    company_name = models.ForeignKey(
        Company, default='', on_delete=models.CASCADE)
...
class GroupUserTable(models.Model):
    team_details = models.ForeignKey(
        teamtable, default='', on_delete=models.CASCADE)
...
class filetable(models.Model):
    ...
    parentfolder = models.ForeignKey(
        foldertable, default='', on_delete=models.CASCADE)
